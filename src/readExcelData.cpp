...
bool ExcelRead::readExcelData(QString& filename)
{
    ...
    int totalRow = usedrange->querySubObject("Rows")->property("Count").toInt();  //获取数据总行数
    int totalCol = usedrange->querySubObject("Columns")->property("Count").toInt();
    //
