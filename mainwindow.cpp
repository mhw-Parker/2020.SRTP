...
//{
//    ui->setupUi(this);
//    setGeometry(400, 250, 1280, 800);
//    Actmotor(ui->customPlot);

//}

//void MainWindow::Actmotor(QCustomPlot *customPlot)
//{
////    train.testmain();
//    customPlot->addGraph();
...
////    QVector<double> x(train.Tmp_SoverNum,0), y(train.Tmp_SoverNum,0);
////    for(int i = 1;i < train.Tmp_SoverNum;i++)
////    {
////        x[i] = (double)train.Tmp_Step_X(i);
////        y[i] = (double)train.Actmotornum_PD(i);
////    }
...
//    customPlot->plotLayout()->addElement(0, 0, new QCPTextElement(customPlot, "PowerDistribution & PowerUnDistribution", QFont("sans", 12, QFont::Bold)));
//    // axis configurations:
//    customPlot->xAxis->setLabel("location");
//    customPlot->yAxis->setLabel("motor number");
...
void MainWindow::ActorMotor(QCustomPlot *customPlot)
{
    ...
    customPlot->graph(0)->setData(x,PD);
